...
public interface ChecklistRepository extends JpaRepository<Checklist, Long> {
    ...
    @Query("SELECT c FROM Checklist c WHERE c.userId = :userId AND c.typeName = :type " + "AND c.checklistCreatedAt BETWEEN :startDate AND :endDate")
    List<Checklist> findByUserIdAndTypeNameAndDateRange(
    ...
    List<Checklist> findByUserIdOrderByChecklistCreatedAtDesc(Long userId);
}
